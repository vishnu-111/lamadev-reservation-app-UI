    ...
    return (
        <div className={styles.header}>
            <div className={type==='list' ?`${styles.headerContainer} ${styles.listMode}`:`${styles.headerContainer}`}>
                ...
                {type !== 'list' && <> <h1 className={styles.headerTitle}>
                    ...
                    <div className={styles.headerSearch}>
                        <div className={styles.headerSearchItem}>
                            ...
                            <input type="text" placeholder='Where are u going ??' className={styles.headerSearchInput} onChange={e=>setDestination(e.target.value)} />
                        </div>
                        <div className={styles.headerSearchItem}>
                            <FontAwesomeIcon icon={faCalendarDays} className={styles.headerIcon} />
                            <span onClick={() => setOpenDate(!openDate)} className={styles.headerSearchText}>{`${format(date[0].startDate, 'MM/dd/yyyy')} to ${format(date[0].endDate, 'MM/dd/yyyy')}`}</span>

                            {openDate &&
                                <DateRange className={styles.date} editableDateInputs={true} onChange={item => setDate([item.selection])} moveRangeOnFirstSelection={false} ranges={date} />
                        ...
                        <div className={styles.headerSearchItem}>
                            ...
                            <span onClick={() => setOpenOptions(!openOptions)} className={styles.headerSearchText}>{`${options.adult} . ${options.children} . ${options.room}`}</span>
                            {openOptions &&
                                    ...
                                    <div className={styles.optionItem}>
                                        ...
                                        <div className={styles.optionCounter}>
                                            ...
                                            <button
                                                ...
                                                className={styles.optionCounterButton} onClick={() => { handleOption("adult", "d") }}>-</button>
                                    ...
                                    <div className={styles.optionItem}>
                                        ...
                                        <div className={styles.optionCounter}>
                                            <button
                                                ...
                                                className={styles.optionCounterButton} onClick={() => { handleOption("children", "d") }}>-</button>
                                    ...
                                    <div className={styles.optionItem}>
                                        ...
                                        <div className={styles.optionCounter}>
                                            <button
                                                ...
                                                className={styles.optionCounterButton} onClick={() => { handleOption("room", "d") }}>-</button>
